if(!window.initVar){
  window.initVar = {
    ...
    meta: {},
    vapidKey: "BJIemW3EsXuuc3nBSxDzD0TjKf1-YCVtvh7_NZ9W_9okFUBLfVdCPoLA4asf6igOFv9X8rmZo19ja8wITO5_Syw",
    clientId: "XNH3DPY1H5QVR5XNPW116CZY",
    ...
    stockFulFilledPushCampaign: {
      isActive: true,
      uniqueId: 'X2Y93SSKHT6BVUP9NUXD7ZTL'
    },
    stockFulFilledEmailCampaign: {
      isActive: true,
      uniqueId: 'QLM4LW1DU2XYSLLLNBLTTEBV'
    },
    stockFulFilledSmsCampaign: {
      isActive: true,
      uniqueId: '6K4SDTE53G9995LFTVYX95MS'
    },
    priceDropPushCampaign: {
      isActive: true,
      uniqueId: 'S2TY9WCBFA3BMN27Z74CFD2Q',
    },
    priceDropEmailCampaign: {
      isActive: true,
      uniqueId: 'CB7XHU8Q1I9JUTSMXWU41ICK',
    },
    priceDropSmsCampaign: {
      isActive: true,
      uniqueId: 'ZUHHAMUQNK92NQS14F9RSE29',
    },
    stockWidget: {
      ...
      buttonType: "inline",
      inlineButtonParentSelector: `AddToCart-6855733805139`,
  ...
  window.onload = function () {
    window.growCampaignPopUp = new Vue({
      ...
      data: {
        ...
        emailWorkflowUniqueId: "QLM4LW1DU2XYSLLLNBLTTEBV",
        smsWorkflowUniqueId: "6K4SDTE53G9995LFTVYX95MS",
